...
export default function Home() {
  return (
    <div className="flex flex-col gap-16 pb-16">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              <FadeIn
                delay={60}
                direction="left">
                <h1 className="text-4xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight mb-6 text-foreground leading-tight text-balance">
                  Need help finding the{" "}
                  <span className="text-primary">best online program</span> for
                  your Career?
                </h1>
              </FadeIn>
              <FadeIn
                ...
                <p className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed max-w-lg">
                  Let us help you find the best online program based on your
              ...
              <FadeIn
                ...
                <div className="mt-10">
                  ...
                  <div className="flex flex-wrap items-start gap-4 sm:gap-6">
                    {[
                      {
                        src: "/accredation-images/naac.png",
                        alt: "NAAC",
                        title: "NAAC A+ Accredited",
                      },
                      {
                        src: "/accredation-images/ugc.png",
                        alt: "UGC",
                        title: "UGC Entitled",
                      },
                      {
                        src: "/accredation-images/nirf.jpg",
                        alt: "NIRF",
                        title: "NIRF Ranking 3",
                      },
                      {
                        src: "/accredation-images/iirf-trans.png",
                        alt: "IIRF",
                        title: "Private University in North East",
                      },
                      {
                        src: "/accredation-images/wes.jpg",
                        alt: "WES",
                        title: "WES Recognized",
                      },
                      {
                        src: "/accredation-images/AICTE-Logo.webp",
                        alt: "AICTE",
      ...
      <section
        id="courses"
        className="bg-muted/30 py-16 overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-muted-foreground">
                Enhance your skills with Industry-recognized, UGC & WES approved
                online degree programs from top-tier universities.
              </p>
            </div>
            <Link
              href="/courses"
      ...
      <section
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            From counselling to placement, we support you at every step of your
            career.
          </p>
        </div>
      ...
      <section className="bg-foreground text-white py-16 rounded-3xl mx-4 mb-16 px-8 md:px-16 text-center">
        <h2 className="text-3xl text-primary-foreground font-bold tracking-tight sm:text-4xl mb-8">
          Admission & Support
        </h2>
        <div className="grid md:grid-cols-3 gap-8 text-left max-w-5xl mx-auto">
          <FadeIn
            delay={100}
            direction="up"
            className="bg-primary/10 p-6 rounded-xl border border-slate-700">
            <h3 className="text-xl text-primary-foreground font-semibold mb-3">
              Seamless Process
            </h3>
            <p className="text-primary-foreground">
              Simple admission process supported by dedicated student counseling
              throughout your program journey.
            </p>
          </FadeIn>
          <FadeIn
            delay={200}
            ...
            <p className="text-primary-foreground">
              Scholarship and flexible payment options available to ensure
          ...
          <FadeIn
            ...
            <p className="text-primary-foreground">
              Access to a robust alumni network. Post-completion, gain access to
              recruitment drives and launchpad events for placements into top
              global MNCs.
            </p>
          </FadeIn>
        </div>
      ...
      <section
        ...
        <div className="mb-12 text-center">
          <FadeIn direction="up">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Partnered with India's top-tier institutions to deliver
              world-class online programs and industry-recognized degrees.
            </p>
          </FadeIn>
        </div>
          ...
          universities={[
            {
              ...
              description:
                "A global hub for industry-focused education, recognized for academic excellence and innovation.",
              image:
                "/universities/amity-university-gwalior-campus-admission.webp",
            },
            {
              name: "DY Patil University, Pune",
              description:
                "Established excellence in Pune, offering quality value-based and cutting-edge education across diverse fields.",
              image: "/universities/Dr.-D.-Y.-Patil-Vidyapeeth.jpg",
            },
            {
              name: "Jain University",
              description:
                "A hub for learning in Bangalore, recognized for its focus on entrepreneurship, research, and sports.",
              image: "/universities/jain university.jpg",
            },
            {
              name: "Lovely Professional University",
              description:
                "One of India's largest multidisciplinary universities with a sprawling 600-acre residential campus.",
              image: "/universities/lpu-jalandhar-360559.webp",
            },
            {
              name: "Manipal University Jaipur",
              description:
                "A NAAC A+ accredited university known for academic excellence and industry-focused learning in Jaipur.",
              image: "/universities/MUJ-mobile-banner.png",
            },
            {
              name: "Noida International University",
              description:
                "An A+ NAAC accredited university in Greater Noida, offering world-class infrastructure and global education.",
              image: "/universities/Noida-university.jpg",
            },
            {
              name: "Sharda University",
              description:
                "A globally recognized institution in Greater Noida, fostering an inclusive and multicultural learning environment.",
              image: "/universities/shardaUniversity.jpg",
            },
            {
              name: "Shoolini University",
              description:
                "A research-focused university in the Himalayas, ranked among top global institutions for innovation.",
              image: "/universities/shooliniUniversity.jpg",
            },
            {
              name: "Sikkim Manipal University",
              description:
                "Pioneering quality education and healthcare in NE India, offering interdisciplinary programs.",
              image: "/universities/Manipal-University-banner.jpg",
            },
            {
              name: "Uttaranchal University",
              description:
                "A state-of-the-art institution in Dehradun, dedicated to research, innovation, and student-centric learning.",
              image: "/universities/uttaranchal university.png",
            },
            {
              name: "Vivekanand Global University",
              description:
                "A premier institution in Rajasthan focusing on holistic education, placements, and industry exposure.",
              image: "/universities/vivekananda global university.jpg",
            },
            {
              name: "Narsee Monjee University",
              description:
                "A leading multi-disciplinary university with a legacy of excellence in management and professional studies.",
      ...
      <section className="bg-muted/30 py-16 overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              EdGrowth has a team of experts giving you the right guidance for
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-muted-foreground">
                    Industry recognized degree from dual accredited global
                    universities.
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-6 w-6 text-green-500 mr-3 shrink-0" />
                  <span className="text-muted-foreground">
                    Extensive diversity of subjects such as AI, data science,
                    big data etc. designed by top business schools.
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-6 w-6 text-green-500 mr-3 shrink-0" />
                  <span className="text-muted-foreground">
                    Learn via pre-recorded videos from globally renowned faculty
                    ensuring best-in-class knowledge.
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-6 w-6 text-green-500 mr-3 shrink-0" />
                  <span className="text-muted-foreground">
                    Networking opportunities with peers from varied industries.
                  </span>
                </li>
              </ul>
            </FadeIn>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-foreground">
          <FadeIn delay={100}>
            <div className="flex flex-col items-center">
              ...
              <h3 className="font-semibold px-2">
                Experienced & Qualified Academic Counsellors
              </h3>
            </div>
          </FadeIn>
          <FadeIn delay={200}>
            <div className="flex flex-col items-center">
              ...
              <h3 className="font-semibold px-2">
                Extensive Expertise in Career Building & Placement
              </h3>
            </div>
          </FadeIn>
          <FadeIn delay={300}>
          ...
          <FadeIn delay={400}>
            <div className="flex flex-col items-center">
              ...
              <h3 className="font-semibold px-2">
                Great Universities Alumni Network
              </h3>
            </div>
          </FadeIn>
        </div>
      ...
      <section
        ...
        <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
          Contact us today to get expert counselling and take the first step
          towards your dream qualification.
        </p>

...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <div className="w-9 h-9" /> // Placeholder to avoid hydration mismatch
    )
  }
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center rounded-md p-2 hover:bg-accent hover:text-accent-foreground transition-colors relative h-9 w-9"
